...
import com.khalti.qreye.app.PERMISSION_CAMERA
import com.khalti.qreye.app.hasCameraPermission
import com.khalti.qreye.graphics.FrameMetrics
import com.khalti.qreye.view.initSystemBars
import com.khalti.qreye.widget.DetectorView
import com.khalti.qreye.widget.toast
//import  com.khalti.qreye.app.prefs
import com.khalti.qreye.graphics.setFrameRoi
import com.khalti.qreye.graphics.setFrameToView
import com.khalti.qreye.view.setPaddingFromWindowInsets
...
//                updateFlashFab(parameters.flashMode == null)
            ...
            override fun onCameraError() {
                this@QRActivity.toast(R.string.camera_error)
            }

            override fun onCameraReady(camera: Camera) {
                print("QRAPP ---> onCameraReady ")
...
//                    tryRotate = prefs.autoRotate,
                ...
                camera.setPreviewCallback { frameData, _ ->
                    print("QRAPP ---> camera.setPreviewCallback ")
                    if (decoding) {
